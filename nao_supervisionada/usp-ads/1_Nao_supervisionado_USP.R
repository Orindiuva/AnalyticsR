...
View(alunos_pap)
#A coluna vira o nome da linha
rownames(alunos_pap) <- alunos_pap[,1]
alunos_pap <- alunos_pap[,-1]
alunos_pap
#CALCULANDO MATRIZ DE DISTANCIAS
#Aqui as variaveis estão na mesma escala, por iso não necessito de padronizá-las.
...
#O ideal é analisar outras informações, como desvio padrao, variabilidade, etc.
